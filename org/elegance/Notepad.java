...
public class Notepad extends JFrame implements ActionListener {
        ...
        private MenuBar menuBar;    // first, create a MenuBar item
        private Menu file; // our File menu

        // what's going in File? let's see...
        private MenuItem openFile; // an open option
        private MenuItem saveFile; // a save option
        private MenuItem close; // and a close option!
        ...
        public Notepad() {
           ...
           //     UIManager.setLookAndFeel("com.sun.java.swing.plaf.nimbus.NimbusLookAndFeel");			//ok								
                ...
                this.setTitle("Sesame Notepad"); // set the title of the window
